...
import { List, LayoutDashboard, TerminalSquare } from 'lucide-react'
    ...
    <div className="hidden lg:flex w-64 flex-col fixed inset-y-0 z-50 bg-black border-r border-border">
      ...
      <div className="px-4 py-6 border-t border-border space-y-4">
        <div className="flex gap-2 items-center">
          <Link
            href="https://github.com/velikanghost/heekowave"
            target="_blank"
            className="group flex items-center bg-primary hover:bg-primary/90 px-3 py-2 text-xs font-medium text-muted-foreground transition-colors"
          >
            <svg
